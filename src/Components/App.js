...
render(){
        ...
        <ul className='blog'><li>Where everyone else gives up, we take over</li>
        <Link to="/contact"><li><button>BOOK OUR SERVICE</button></li></Link>
        </ul>
              ...
              <div className='list'>
                ...
                <p><strong> Fully Insured &#38; Equipped Handyman</strong><br/>The handyman carry public liability insurance and have all the
